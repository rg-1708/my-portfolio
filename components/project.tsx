...
export default function Project({
  ...
  const scaleProgress = useTransform(scrollYProgress, [0, 1], [0.825, 1]);
  ...
  return (
    ...
    sm:pr-8 relative sm:h-[20rem] group-odd:pl-8 rounded-lg
    hover:bg-gray-200 transition"
      >
        <div
          className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 
      sm:max-w-[50%] flex flex-col h-full group-odd:ml-[18rem]"
        >
